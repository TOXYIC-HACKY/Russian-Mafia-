        ...
        try {
            ...
            SUPUNMDInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = 'HACKLINK=' + stringSession;  // Prepend your name to the session ID
                    ...
                    await SUPUNMDInc.sendMessage(userJid, { text: "*🪄 HACKLINK TECH.INC BOTS  New Update.....💐*\n\n* SESION SUCCESSFUL ✅\n\n*උඩ ආපු Sesion Id connected successfully proceed to Deployment 😩🪄💐*\n\n+ ┉┉┉┉┉┉┉┉[ ❤️‍🩹 ]┉┉┉┉┉┉┉┉ +\n*❗𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐆𝐑𝐎𝐔𝐏*\n* https://chat.whatsapp.com/E9mVfukNRX13eF45Wbmk7t\n\n*❗𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍𝐄𝐋*\n* https://whatsapp.com/channel/0029Vb6Gy5XDzgTBTarvMW1\n\n*❗BLACK-HAWK 𝐂𝐎𝐍𝐓𝐀𝐂𝐓*\n* wa.me/254769677305\n\n\n> 𝙿𝙾𝚆𝙴𝚁𝙳 BY HACKLINK TECH.INC🫟" });
